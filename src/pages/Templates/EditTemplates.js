...
import FindTemplateById from "../../API/Documents/FindTemplateById";
const EditTemplates = () => {
  ...
  const [Tname, setTName] = useState(state.template_name);
  ...
  const updateTemplate = (e) => {
    ...
    const options = {
      method: "PUT",
      url: `http://192.168.0.22:8000/document/updateDocument/${tId}`,
      headers: {
        "Content-Type":
        ...
        <form>
          ...
          <div className="container-fluid round-border bg-white p-4 mt-4 rounded-2xl">
            <div className="row">
              ...
              {loading === false ? (
                <>
                  {reciept.actions.map((item, index) => {
                              ...
                              >
                                ...
                                <Offcanvas.Body>
                                  ...
                                  <div className="provider">
                                    ...
                                    <p>
                                      Select the digital signature providers to
                                      be made available for this recipient to
                                      sign this document(s) with.
                                    </p>
                                    <input
                                      type="radio"
                                      id="allprovide"
                          ...
                          >
                            <label for="name" class="form-label">
                              <i
                                ...
                                style={{ marginRight: "7px", color: "#000" }}
                              ></i>{" "}
                              Private message :
                            </label>
                          </div>
              ...
              >
                ...
                >
                  ...
                  <div className="col-md-4">
                    ...
                    {on === true ? (
                      <p>
                        Automatic reminder will be delivered via email even if
                        the delivery mode is set to 'Email + SMS'.
                      </p>
                    ) : (
                      <p>
                        If enabled, automatic reminders will only be delivered
                        via email.
                      </p>
                    )}
                  </div>
