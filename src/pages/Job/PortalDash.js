...
const PortalDash = () => {
  ...
  return (
    ...
    <div className="container dashboard-page mt-2">
      ...
      <h3>Dashboard</h3>
      <span>On this screen you can get all the essential status of your work</span>
      </div>
      <div className="row">
<div className="col-md-4 ">
  <DashCard bgclass="first-card" iclass="fa-solid fa-check-to-slot" cardtitle="Assigned Jobs" cardnumber="4" cardpara="You have pending assigned jobs"/>
</div>
<div className="col-md-4 ">
  <DashCard bgclass="second-card" iclass="fa-solid fa-book-open" cardtitle="Open Jobs" cardnumber="1799" cardpara="Total Number of Open Jobs"/>
</div>
<div className="col-md-4 ">
  <DashCard bgclass="third-card" iclass="fa-solid fa-earth-americas" cardtitle="Total Jobs" cardnumber="35209" cardpara="All Jobs coming from all VMS "/>
</div>
